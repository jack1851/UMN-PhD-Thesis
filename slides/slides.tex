...
\begin{frame}{Analysis Regions}
  \begin{figure}
    \centering
    \input{../figures/theory/analysis-regions}
...
\begin{frame}{Signal Region Backgrounds}
  \begin{columns}
    ...
    \begin{column}{0.50\textwidth}
      ...
      \vspace{1ex} 
      \begin{block}{Changing backgrounds with $m_{\ell\ell j j}$}
...
\section{Drell-Yan Estimation} % \ssection{Drell-Yan Estimation}
...
\section{Looking Forward to Run 3} % \ssection{Looking Forward to Run 3}
...
\begin{frame}{Conclusion}
  Many improvements and areas of study under development in the $W_R$ and $N$ search:

  \begin{columns} % [t] for top alignment of columns
    %――――――――――――――――――――――――――――
    \begin{column}{0.5\textwidth}
      \begin{block}{Looking Forward to Run 3}
        Beginning comparisons in the DY CR and Flavor CR for Run 3 Data/MC, with a new
        reweighting variable to correct the DY MC.
      \end{block}

      \begin{block}{Optimization Studies}
        \begin{itemize}
          \item Checking if the signal region definition of $m_{\ell \ell} > 400 \mathrm{~GeV}$ 
    ...
    \begin{column}{0.5\textwidth}
      \centering
      % Replace “example-image” with your actual filename
...
\begin{frame}{Experiment}
  \resizebox{\textwidth}{!}{\input{../figures/hps/experiment/hps-diagram}}
  \vfill
  \begin{columns}
    \begin{column}{0.32\textwidth}
