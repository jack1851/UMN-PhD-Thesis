...
\item Short conclusion at the end
}
...
\begin{frame}{Left-Right Symmetric Model}
  \begin{block}{Postulate of Left-Right Symmetric Models}
    Parity violation is a low energy phenomenon that is restored at a multi-TeV energy scale.
  \end{block}
  \vfill
  \begin{table}
...
\begin{frame}{Seesaw Mechanism}
  \begin{figure}
    \centering
    \includegraphics[width=0.75\textwidth]{seesaw-mechanism.png}
    \caption{Seesaw mechanism in action. Artwork by Sandbox Studio, Chicago with Ana Kova.}
  \end{figure}
\end{frame}
