...
\begin{frame}{Parity Violation in $\beta$ Decay}
  ...
  \begin{columns}
    \begin{column}{0.65\textwidth}
      \begin{figure}
        \centering
        \includegraphics[width=\textwidth]{figs/wu-experiment.png}
      \end{figure}
    \end{column}
...
\begin{frame}{Conclusion}
  ...
  \begin{columns} % [t] for top alignment of columns
    ...
    \begin{column}{0.5\textwidth}
      \centering
      \includegraphics[width=0.75\textwidth]{figs/wr-boson-chatgpt.png}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{backup}
  ...
  \begin{frame}{Seesaw Mechanism}
    \begin{figure}
      \centering
      \includegraphics[width=0.70\textwidth]{figs/seesaw-mechanism.png}
